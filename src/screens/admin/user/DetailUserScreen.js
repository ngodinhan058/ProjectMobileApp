    ...
    <View style={styles.container}>
        ...
        <View style={styles.userDetailContainer}>
          ...
          <View style={styles.userInfo}>
            ...
            <View>
              ...
              <Text style={styles.userPrice}>{money} &#273;</Text>
              <Text style={styles.userSale}>Địa Chỉ: {address}</Text>
            </View>

            <View style={styles.SolduserInfo}>
              <Text style={styles.userStar}>Bậc:</Text>
              <View>
                <Image
                  source={rank}
                  style={{ width: 25, height: 25, marginRight: 190 }}
                />
              </View>
              <View>
          ...
          <View>
            <Text style={styles.descriptionuserTitle}>
              Số CCCD: {number_id}
            </Text>
      ...
      <Animated.View style={[styles.subButtonPen, { bottom: position2 }]}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('EditUserScreen', { id })}
        >
