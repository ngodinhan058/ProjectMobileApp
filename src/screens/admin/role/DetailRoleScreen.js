...
function DetailScreen({ route, navigation }) {
    const { id, name, permissions } = route.params;
            ...
            <ScrollView>
                <View style={{
                    ...
                    <LinearGradient colors={['#2196F3', '#1976D2']} style={styles.header}>
                        ...
                        <Text style={styles.textHeader}>Chi Tiết Quyền Người Dùng</Text>
                    </LinearGradient>
                ...
                <View style={styles.productInfo}>
                    <Text style={styles.title}>Tên Quyền Người Dùng: </Text>
                    <Text style={styles.productName}>{name}</Text>
                </View>
                <View style={styles.productInfo}>
                    <Text style={styles.title}>Những Quyền Cho Phép: </Text>
                    {permissions.map((item) => (
                        <View key={item.permissionId}>
                            <Text style={styles.productName}>{item.permissionName}</Text>
                        </View>
                    ))}
