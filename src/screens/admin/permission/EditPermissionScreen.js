        ...
        <View style={styles.container}>
            <ScrollView>
                <LinearGradient colors={['#2196F3', '#1976D2']} style={styles.header}>
                    ...
                    <Text style={styles.textHeader}>Sửa Thông Tin Quyền Cho Phép</Text>
                </LinearGradient>
                <View style={styles.formContainer}>
                    <Text style={styles.label}>Sửa Thông Tin Quyền Cho Phép: </Text>
                    <TextInput
                        style={styles.input}
                        placeholder="Nhập Tên Thông Tin Quyền Cho Phép"
