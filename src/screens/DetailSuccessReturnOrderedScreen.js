...
function DetailSuccessReturnOrderedScreen({ route, navigation }) {
  return (
    <ScrollView style={{ marginTop: 60, padding: 20 }}>
      <View style={styles.container}>
        ...
        <View
          style={{
            ...
            backgroundColor: '#3669C9', // Color of the line
      ...
      <View>
        ...
        <Text style={{ marginBottom: 10 }}>
          Số tiền 1.500.000 ₫ sẽ được hoàn vào Số dư TK MegaMall của bạn trong
          24h
        </Text>
      </View>
      <View>
...
export default DetailSuccessReturnOrderedScreen;
